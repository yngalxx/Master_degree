...
parameters = {
    ...
    'batch_size': 16,
    'num_epochs': 20,
    'rescale': [600, 600], # if float, each image will be multiplied by it, if list [width, height] each image will be scaled to that size (concerns both images + annotations)
    'shuffle': False, 
    'weight_decay': 0, # regularization
    'lr_scheduler': True, # lr scheduler
    'lr_step_size': 7, # lr scheduler step
    'lr_gamma': .5, # lr step multiplier 
