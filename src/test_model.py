...
def model_predict(
    ...
    with torch.no_grad():
        image_id_list, img_name_list, predicted_box_list, predicted_label_list, score_list, new_size_list = [], [], [], [], [], []
        for images, targets in tqdm(dataloader):
            ...
            for target in list(targets):
                ...
                img_name_list.append(int([t.detach().numpy() for t in target['image_name']][0]))
            ...
            for output in outputs:
                ...
                score_list.append([o.detach().numpy().tolist() for o in output['scores']])
